...
//   const namelist= document.querySelector('.mw-category');
//   const links= Array.from(namelist.querySelectorAll('a'));
//   if(links){ const de = links
//   .map(name=> name.textContent)
//   .filter(names=>names.includes('de'));
// }

// 7. sort Exercise
// Sort the people alp(habetically by last name
